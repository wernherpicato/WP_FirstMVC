...
namespace WP_FirstMVC.Models

{
    public class DataContext : DbContext
    {
        public DataContext() : base("EnvisionConnectMVC")
        {
            // This will call the "Seeder" (FeedbackInitializer)
            // Comment this one out when pointing to the production tables
            //   Database.SetInitializer<FeedbackContext>(new FeedbackInitializer());
        }

        public DbSet<TB_CORE_OWNER> TB_CORE_OWNER { get; set; }
    ...
    //public class FeedbackInitializer : DropCreateDatabaseIfModelChanges<DataContext>
    //{
